...
const URL = "https://gakcreations.com/terms";
...
function Terms() {
  return (
    <PolicyPage eyebrow="Legal" title="Terms of Service" updated="July 2026">
      <p>
        These Terms of Service govern your access to and use of the GAK
        Creations website and the purchase of any products offered through it.
        By using the site or placing an order, you agree to these terms.
      </p>

      <PolicyH2>The Studio</PolicyH2>
      <p>
        GAK Creations is the trading name of the personal studio of Gerald Allen
        Knowles, publishing architectural drawings and travel collages as fine
        art prints. Orders are fulfilled by our print-on-demand partner
        Printify.
      </p>

      <PolicyH2>Intellectual Property</PolicyH2>
      <p>
        All artwork, images, text, and design elements on this site are the
        property of Gerald Allen Knowles and GAK Creations and are protected by
        copyright. You may not reproduce, distribute, or create derivative works
      ...
      <p>
        ...
        reserve the right to refuse or cancel any order for reasons including,
        but not limited to, product unavailability, pricing errors, or
        suspected fraud.
      </p>
      ...
      <p>
        To the fullest extent permitted by law, GAK Creations shall not be
        liable for any indirect, incidental, or consequential damages arising
        from your use of the site or products purchased through it. Our
        aggregate liability shall not exceed the amount paid by you for the
      ...
      <p>
        ...
        studio is registered. Any dispute shall be resolved in the competent
